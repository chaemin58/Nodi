...
export function MeetingAddCard() {
  ...
  return (
    <div
      onClick={() => modal?.open()}
      className="w-full min-h-68 lg:min-h-70 cursor-pointer overflow-hidden border-border-default rounded-2xl bg-surface border-2 border-dashed p-5 flex flex-col justify-center items-center gap-3 self-stretch"
    >
